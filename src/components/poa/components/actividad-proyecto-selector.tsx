...
export function ActividadProyectoSelectorComponent() {
  const [selectedOption, setSelectedOption] = useState<"actividad" | "proyecto">("proyecto")
  ...
  return (
    <div className="space-y-4">
      <RadioGroup
        ...
        onValueChange={(value) => setSelectedOption(value as "actividad" | "proyecto")}
