...
export default function UserManagement() {
  ...
  const [roleFilter, setRoleFilter] = useState("all") // Initialize to "all"
      ...
      <div className="mb-4 flex space-x-4">
        ...
        <div className="flex-1">
          ...
          <Select value={roleFilter} onValueChange={setRoleFilter}>
            ...
            <SelectContent>
              <SelectItem value="all">Todos los roles</SelectItem> {/* Changed value from "" to "all" */}
...
function UserForm({ onSubmit, initialData, onCancel }: {
  ...
  const [role, setRole] = useState(initialData?.role || "Administrador") // Set a default role if needed
